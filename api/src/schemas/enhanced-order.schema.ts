import { z } from "zod";
import { CommonSchemas, VALIDATION_RULES } from "../config/validation";

// Enhanced order schemas with comprehensive validation
export const EnhancedCreateOrderSchema = z.object({
...
export const EnhancedUpdateOrderStatusSchema = z.object({
