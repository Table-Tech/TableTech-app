...
export const createStaffHandler = async (
  ...
  return await controller.createLegacyStaff(req, reply);
};
...
export const getStaffHandler = async (
  ...
  const controller = new StaffController();
  return await controller.getLegacyStaff(req, reply);
};
...
export const getStaffByIdHandler = async (
  ...
  const controller = new StaffController();
  return await controller.getLegacyStaffById(req, reply);
};
...
export const updateStaffHandler = async (
  ...
  const controller = new StaffController();
  return await controller.updateLegacyStaff(req, reply);
};
...
export const deleteStaffHandler = async (
  ...
  const controller = new StaffController();
  return await controller.deleteLegacyStaff(req, reply);
};