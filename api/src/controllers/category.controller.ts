...
export const createCategoryHandler = async (
  ...
  return await controller.createLegacyCategory(req, reply);
};
...
export const getCategoriesHandler = async (
  ...
  const controller = new CategoryController();
  return await controller.getLegacyCategories(req, reply);
};
...
export const getCategoryHandler = async (
  ...
  const controller = new CategoryController();
  return await controller.getLegacyCategory(req, reply);
};
...
export const updateCategoryHandler = async (
  ...
  const controller = new CategoryController();
  return await controller.updateLegacyCategory(req, reply);
};
...
export const deleteCategoryHandler = async (
  ...
  const controller = new CategoryController();
  return await controller.deleteLegacyCategory(req, reply);
};